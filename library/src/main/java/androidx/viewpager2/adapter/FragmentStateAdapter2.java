 ...
 * {@link Fragment}.
 * </ul>
 * 重新写官方的 FragmentStateAdapter
 * 1：mFragments 变成public
 * 2:onBindViewHolder final去除
 * 3:removeFragment 变成public  添加是否从FragmentManage remove
 */
public abstract class FragmentStateAdapter2 extends
     ...
     * @see FragmentStateAdapter2#FragmentStateAdapter2(Fragment)
     * @see FragmentStateAdapter2#FragmentStateAdapter2(FragmentManager, Lifecycle)
     */
     ...
     * @see FragmentStateAdapter2#FragmentStateAdapter2(FragmentActivity)
     * @see FragmentStateAdapter2#FragmentStateAdapter2(FragmentManager, Lifecycle)
     */
     ...
     * @see FragmentStateAdapter2#FragmentStateAdapter2(Fragment)
     */
    public FragmentStateAdapter2(@NonNull FragmentManager fragmentManager,
    ...
    public void removeFragment(long itemId) {
        removeFragment(itemId, true);
    }

    public void removeFragment(long itemId, boolean isFragmentManagerRemove) {
        Fragment fragment = mFragments.get(itemId);
